(function (global, factory) {
  ...
  const { LEFT_BRACE, RIGHT_BRACE, LEFT_BRACKET, RIGHT_BRACKET, COLON, COMMA, TRUE, FALSE, NULL, STRING, NUMBER, } = exports.TokenType;
  // Tokenizer States
  var TokenizerStates;
  ...
  const { LEFT_BRACE: LEFT_BRACE$1, RIGHT_BRACE: RIGHT_BRACE$1, LEFT_BRACKET: LEFT_BRACKET$1, RIGHT_BRACKET: RIGHT_BRACKET$1, COLON: COLON$1, COMMA: COMMA$1, TRUE: TRUE$1, FALSE: FALSE$1, NULL: NULL$1, STRING: STRING$1, NUMBER: NUMBER$1, } = exports.TokenType;
  // Parser States
  var ParserState;
  ...
  class AsyncParser {
      ...
      async write(token, value) {
          ...
          throw new Error("Unexpected " + exports.TokenType[token] + (("(" + JSON.stringify(value) + ")")) +
  ...
  exports.JsonParser = AsyncJSONParser;
  exports.Parser = AsyncParser;
  exports.Tokenizer = AsyncTokenizer;
  exports.utf8 = utf8;
